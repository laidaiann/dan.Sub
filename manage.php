...
<body>
	<div class="container">
		...
		<?php
		// [Fix] Safe include check
		// Ensure $include_path is valid AND exists to prevent fatal errors
		if ($getLib->checkVal($include_path) && file_exists($include_path)) {
			include($include_path);
		} else {
			$error_msg = "找不到網頁";
			$error_msg_array = array();
			// [Fix] Use [] for push
			$error_msg_array[] = $error_msg;
